...
const uiTexts = {
    pt: { 
        ...
        obT2: "Radar GPS", obD2: "Fica atento às cores: laranja é perto, vermelho a pulsar é quase lá! (Dica: Mantém o jogo aberto enquanto caminhas)", 
    ...
    en: { 
        ...
        obT2: "GPS Radar", obD2: "Watch the colors: orange is close, pulsing red means you are almost there! (Tip: Keep the app open while walking)", 
    ...
    es: { 
        ...
        obT2: "Radar GPS", obD2: "Atento a los colores: naranja es cerca, rojo parpadeando es casi allí. (Consejo: Mantén la app abierta al caminar)", 
    ...
    fr: { 
        ...
        obT2: "Radar GPS", obD2: "Surveillez les couleurs : orange c'est près, rouge clignotant c'est tout près ! (Astuce : Gardez l'app ouverte en marchant)", 
    ...
    de: { 
        ...
        obT2: "GPS-Radar", obD2: "Achte auf die Farben: Orange ist nah, pulsierendes Rot bedeutet fast da! (Tipp: Lass die App beim Gehen offen)", 
    ...
    it: { 
        ...
        obT2: "Radar GPS", obD2: "Guarda i colori: arancione è vicino, rosso lampeggiante è quasi arrivato! (Consiglio: Tieni l'app aperta mentre cammini)", 
    ...
    zh: { 
        ...
        obT2: "GPS雷达", obD2: "观察颜色：橙色代表接近，闪烁的红色表示即将到达！（提示：走路时请保持应用开启）", 
