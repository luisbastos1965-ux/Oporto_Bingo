...
const locations = [
    { 
        ...
        desc: { pt: "O coração histórico da cidade, banhado pelo rio Douro. As suas casas coloridas são um ícone mundial.", en: "The historic heart of the city, bathed by the Douro River. Its colorful houses are a global icon.", es: "El corazón histórico de la ciudad, bañado por el río Duero. Sus coloridas casas son un icono mundial.", fr: "Le cœur historique de la ville, baigné par le fleuve Douro. Ses maisons colorées sont une icône mondiale.", de: "Das historische Herz der Stadt am Douro. Seine bunten Häuser sind ein weltweites Symbol.", it: "Il cuore histórico della cidade, bagnato dal fiume Douro. Le sue case colorate sono un'icona mondiale.", zh: "这座城市的历史中心，沐浴在杜罗河畔。其色彩缤纷的房屋是全球的标志。" },
    ...
    { 
        ...
        hist: { pt: "Reconstruída no século XVIII, a fachada foi revestida em 1932 com 11 mil azulejos.", en: "Rebuilt in the 18th century, the facade was covered in 1932 with 11,000 tiles.", es: "Reconstruida en el siglo XVIII, the fachada fue revestida en 1932 con 11.000 azulejos.", fr: "Reconstruite au XVIIIe siècle, la façade a été recouverte en 1932 de 11 000 tuiles.", de: "Die im 18. Jahrhundert erbaute Fassade wurde 1932 mit 11.000 Kacheln verkleidet.", it: "Ricostruita nel XVIII secolo, la facciata è stata ricoperta nel 1932 con 11.000 piastrelle.", zh: "重建于18世纪，1932年外墙铺设了11000块瓷砖。" },
    ...
    { 
        ...
        curio: { pt: "A sua forma geométrica assimétrica faz lembrar um meteorito que aterrou na cidade.", en: "Its asymmetrical geometric shape resembles a meteorite that landed in the city.", es: "Su forma geométrica asimétrica se asemeja a un meteorito que aterrizó in la cidade.", fr: "Sa forme géométrique asymétrique ressemble à une météorite qui aurait atterri dans la ville.", de: "Seine asymmetrische Form erinnert an einen Meteoriten, der in der Stadt gelandet ist.", it: "La sua forma geometrica asimmetrica ricorda un meteorite atterrato in città.", zh: "其不对称的几何形状类似于降落在城市中的陨石。" }
    },
    { 
    ...
    { 
        ...
        desc: { pt: "O teatro mais prestigiado da cidade, com uma arquitetura elegante.", en: "The most prestigious theater in the city, with elegant architecture.", es: "El teatro más prestigioso de la ciudad, con una arquitectura elegante.", fr: "Le théâtre le plus prestigieux de la ville, avec une architecture élégante.", de: "Das renommierteste Theater der Stadt mit eleganter Architektur.", it: "Il teatro mais prestigiato della città, com uma architettura elegante.", zh: "这座城市最负盛名的剧院，拥有优雅的建筑。" },
    ...
    { 
        ...
        hist: { pt: "Erguido sobre as ruínas do Convento de São Francisco, ardido em 1832.", en: "Built on the ruins of the São Francisco Convent, burned down in 1832.", es: "Construido sobre las ruinas del Convento de San Francisco, incendiado en 1832.", fr: "Palais construit sur les ruines du couvent de São Francisco, incendié en 1832.", de: "Erbaut auf den Ruinen des 1832 niedergebrannten Klosters São Francisco.", it: "Costruito sulle rovine del Convento di São Francisco, bruciato nel 1832.", zh: "建于1832年被烧毁的圣弗朗西斯科修道院的废墟上。" },
...
// Janela Modal Inteligente (Com Modo Mistério)
function openModal(loc) {
    ...
    if (loc.unlocked) {
        ...
        // Modo Mistério Ativo: Remove imagem e oculta abas secretas
...
// Motores Externos: Mapas (Corrigido), Áudio e Partilhas
function openMap() {
